...
public class PresentationScreenMonitor {
    ...
    private final MediaRouter.SimpleCallback mMediaRouterCallback = new MediaRouter.SimpleCallback() {
        ...
        public void onRoutePresentationDisplayChanged(MediaRouter router, MediaRouter.RouteInfo info) {
            ...
            if ((presentationDisplay == null
                    || com.softwinner.fireplayer.util.ReflectionUtil.getDisplayType(presentationDisplay) != 0)
    ...
    public Display getPresentationDisplay() {
        ...
        if (display == null || com.softwinner.fireplayer.util.ReflectionUtil.getDisplayType(display) != 0) {
            return display;
        }
        return null;
    }
