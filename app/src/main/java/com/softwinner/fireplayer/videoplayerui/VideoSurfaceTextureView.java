...
public class VideoSurfaceTextureView
    ...
    public String getSubCharset() {
        ...
        return com.softwinner.fireplayer.util.ReflectionUtil.getSubCharset(this.mMediaPlayer);
    }
    ...
    public int setSubDelay(int time) {
        ...
        return com.softwinner.fireplayer.util.ReflectionUtil.setSubDelay(this.mMediaPlayer, time);
    }
    ...
    public boolean set3DMode(int mode3d, boolean mManual) {
        ...
        if (display != null && com.softwinner.fireplayer.util.ReflectionUtil.getDisplayType(display) == 2) {
            Log.v(this.TAG, "set 3DMode hdmi =" + mode3d);
            Utils.invokeMethod(this.mDisplayManager, "setDisplay3DMode",
                    new Object[] {
                            Integer.valueOf(com.softwinner.fireplayer.util.ReflectionUtil.getDisplayType(display)),
