...
import com.dismal.fireplayer.mediamanager.LocalMediaScannerService;
import com.dismal.fireplayer.provider.LocalMediaProviderContract;
import com.dismal.fireplayer.provider.MySuggestionProvider;
import com.dismal.fireplayer.ui.MediaPlayerEventInterface;
import com.dismal.fireplayer.ui.PresentationScreenMonitor;
import com.dismal.fireplayer.ui.RemoteControlPanel;
import com.dismal.fireplayer.ui.VideoFolderFragment;
import com.dismal.fireplayer.ui.VideoThumbsFragment;
import com.dismal.fireplayer.util.SimpleNotifyDialog;
...
import com.dismal.fireplayer.videoplayerui.PlayListMediaInfoAdapter;
import com.dismal.fireplayer.videoplayerui.SettingDialog;
...
public class FourKMainActivity extends SlidingFragmentActivity implements VideoFolderFragment.onFolderSelectedListener,
    ...
    public static final String FKM_ACTION_SWITCH_PRESENTATION = "com.dismal.fireplayer.action.switch_presentation";
    ...
    public void onRequestPermissionsResult(int requestCode, String[] permissions, int[] grantResults) {
        ...
        if (requestCode == 101) {
            if (grantResults.length > 0 && grantResults[0] == PackageManager.PERMISSION_GRANTED) {
                ...
                com.dismal.fireplayer.util.Utils.makeToast(this, "Storage permission is required to list videos.");
            }
        }
    }
